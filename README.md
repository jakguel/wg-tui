...
- Edit tunnel configurations directly in the TUI
...
| `Enter` | Edit tunnel config |
| `t` | Toggle tunnel (start/stop) |
...
When editing a tunnel configuration:
